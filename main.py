...
for index, row in df.iloc[:].iterrows():
    ...
    heu = Knapsack_Heuristic(LP_penaltiy_rate, LP_max_percentage, LP_min_value, nI, nK, Profits, Weights, Capacity , cpu_time_limit)
    ...
    # write in excel_1
    #heu.write_excel ( LP_penaltiy_rate, LP_max_percentage, LP_min_value, len_ItemsPool , run_id , category \
